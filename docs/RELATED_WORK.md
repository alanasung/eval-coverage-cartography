...
This note situates **When Benchmarks Saturate, What Did They Never Measure** against the mentor-linked literature for
[When Benchmarks Saturate, What Did They Never Measure](https://github.com/alanasung/eval-coverage-cartography).

## Positioning

Use activation geometry to map which capabilities a eval suite actually stresses.

The design hypothesis is: Use activation geometry to map which capabilities a eval suite actually stresses.
