...
from evalmap.configs.loader import register_schema
...
def _load_stage_registry(package: str = "evalmap") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in evalmap.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from evalmap.configs.loader import config_to_dict, save_resolved_config
    from evalmap.models.device import get_device
    from evalmap.utils.logging import configure_logging
    from evalmap.utils.reproducibility import set_seed
    from evalmap.utils.run_manifest import create_run_dir, save_run_metadata
