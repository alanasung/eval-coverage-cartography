import json
from evalmap.reporting.aggregate import aggregate_results, flatten_metrics
from evalmap.reporting.tables import write_tables
from evalmap.reporting.figures import write_caption, write_figures
